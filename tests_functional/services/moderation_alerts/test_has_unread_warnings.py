...
async def test_v1_has_unread_warnings__has_moderation_warnings_from_set_rs_last_visit_date__return_warnings(
        http,
        pg,
        runtime_settings,
):
    ...
    await runtime_settings.set({'DEFAULT_LAST_VISIT_DATE': 1623235883})
...
async def test_v1_has_unread_warnings__has_moderation_warnings_from_default_rs_last_visit_date__return_warnings(
        http,
        pg,
):
    # arrange
