...
@pytest.mark.parametrize(
    ...
    (
        (
            ...
            'Очаково I Кунцево I Кунцево I станиция Крылья ЖК жилой комплекс 1-комн. кв., '
            '68 м², 6/39 этаж 1 комн комнатная 6 39 Продается однокомнатная квартира  98 '
            'в новостройке'
        ),
        (
            ...
            'Крылья ЖК жилой комплекс 1-комн. кв., 68 м², 6/39 этаж 1 комн комнатная 6 39 '
