...
DB_TIMEOUT_DELETE_OFFERS: int = 30
...
SYNC_OFFERS_RESEND_ALL: bool = False
SYNC_OFFERS_BULK_SIZE: int = 1000
...
OFFERS_SYNC_PAGE_SIZE: int = 1000

FAVORITES_FROM_MCS: bool = True
