...
@pytest.mark.parametrize(
    ...
    (
        (
            ...
            '73 73д Кировский Центр район 1-комн. кв., 123 м², 1/3 этаж zzzzzzzzz 1 комн '
        ...
        (
            ...
            'Братиславская метро 3-комн. кв., 90 м², 22/22 этаж 3 комн комнатная 22 22 '
        ...
        (
            ...
            '3-комн. кв., 110 м², 9/15 этаж Просторная трёшка в ЖК "Загорье"! 3 комн '
