...
from my_offers.repositories.postgresql.offer import save_offer_archive
...
async def test_save_offer_archive(mocker):
    ...
    offer = Offer(
        ...
        search_text='zzzzzzz',
        row_version=row_version_archive,
    ...
    # act
    await save_offer_archive(offer)
    ...
    pg.get().execute.assert_called_once_with(
        ...
        'VALUES ($8, $7, $22, $2, $9, $18, CAST($16 AS offer_service[]), $15, $5, $4, $3, $14, $13, $1, $21, $20, '
        '$11, $12, $23, $19, $17, $6) '
        ...
        'is_in_hidden_base = excluded.is_in_hidden_base, has_photo = excluded.has_photo, row_version = $10, '
