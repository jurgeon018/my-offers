...
async def test_save_offer(mocker):
    ...
    # act
    await save_offer(offer=offer, event_date=event_date)
    ...
    pg.get().execute.assert_called_once_with(
        ...
        'VALUES ($8, $7, $23, $2, $9, $19, CAST($16 AS offer_service[]), $15, $5, $4, $3, $14, $12, $1, $22, $21, $10, '
        '$11, $24, $20, $17, $6) ON CONFLICT (offer_id) '
        ...
        'WHERE offers.row_version < $13 AND offers.status_tab != $18 OR false',
