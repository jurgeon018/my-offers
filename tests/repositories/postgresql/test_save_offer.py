...
async def test_save_offer(mocker):
    ...
    pg.get().execute.assert_called_once_with(
        ...
        'total_area, price, price_per_meter, walking_time, street_name, sort_date, is_test, district_id, house_id)'
        ' VALUES ($10, $9, $24, $2, $11, $20, CAST($18 AS offer_service[]), $17, $7, $6, $4, $16, $14, $1, $23,'
        ' $22, $12, $13, $25, $21, $19, $8, $3, $5) ON CONFLICT (offer_id) DO UPDATE SET master_user_id ='
        ' excluded.master_user_id, user_id = excluded.user_id, deal_type = excluded.deal_type, offer_type ='
        ' excluded.offer_type, status_tab = excluded.status_tab, services = excluded.services, search_text ='
        ' excluded.search_text, is_manual = excluded.is_manual, is_in_hidden_base = excluded.is_in_hidden_base,'
        ' has_photo = excluded.has_photo, row_version = excluded.row_version, raw_data = excluded.raw_data,'
        ' updated_at = excluded.updated_at, total_area = excluded.total_area, price = excluded.price, price_per_meter'
        ' = excluded.price_per_meter, walking_time = excluded.walking_time, street_name = excluded.street_name,'
        ' sort_date = excluded.sort_date, is_test = excluded.is_test, district_id = excluded.district_id, house_id'
        ' = excluded.house_id WHERE offers.row_version < $15',
