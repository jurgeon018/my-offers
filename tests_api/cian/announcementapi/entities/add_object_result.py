...
class Status(StrEnum):
    ...
    """Публикация не завершена, но все параметры сохранены, публикация будет завершена позднее"""
    success = 'success'
